...
public class IntegerConverterTest {
    ...
    void 제대로_된_숫자문자열이_들어왔을_때_IntegerList로_변환() {
        ...
        assertThat(IntegerConverter.convert(input)).isEqualTo(expected);
    }
    ...
    void 숫자가_아닌_값이_들어왔을_떼_예외를_던지는지_테스트() {
        ...
        assertThrows(RuntimeException.class, () -> IntegerConverter.convert(input));
    }
    ...
    void 빈_문자열을_입력했을_때_빈_리스트를_리턴하는지_테스트() {
        ...
        assertThat(IntegerConverter.convert(input)).isEqualTo(empty);
    }
}
