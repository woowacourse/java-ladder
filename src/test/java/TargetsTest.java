...
public class TargetsTest {
    ...
    void notEqual() {
        ...
        Assertions.assertThatThrownBy(() -> Targets.from(List.of("1000", "2000", "3000"), PlayerCount.fromPlayers(players)))
    ...
    @Test
    void getTarget() {
        Players players = Players.from(List.of("bito", "kirby", "pobi"));
        Targets targets = Targets.from(List.of("1000", "2000", "3000"), PlayerCount.fromPlayers(players));
