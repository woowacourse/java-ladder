...
class NameInputViewTest {
    ...
    void validateNameNotFound() {
        assertThatThrownBy(() -> NameInputView.getNameThatNeedToShowResult(() -> "abc", Set.of("abcd,ab")))
                .isInstanceOf(LadderGameException.class)
    ...
    void getNameThatNeedToShowResult(String name) {
        String nameThatNeedToShowResult = NameInputView.getNameThatNeedToShowResult(() -> name, Set.of("a", "b", "c"));
