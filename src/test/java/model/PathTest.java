...
class PathTest {
    ...
    void calculatePath_메소드는_좌측_Path와_이동할_수_있는지_여부가_주어지면_Path를_반환한다(Path otherPath,
    ...
    void calculatePath_메소드는_이동할_수_있는지_여부가_주어지면_Path를_반환한다(boolean passable, Path expected) {
    ...
    @Nested
    class isMultiplePassable_메소드_테스트 {
        @Test
