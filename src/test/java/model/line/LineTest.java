...
class LineTest {
    ...
    private static Stream<Arguments> provideDuplicatedBridges() {
        return Stream.of(
                Arguments.of(List.of(CONNECTED, CONNECTED, UNCONNECTED), List.of(CONNECTED, UNCONNECTED, UNCONNECTED)),
                Arguments.of(List.of(UNCONNECTED, CONNECTED, CONNECTED, UNCONNECTED), List.of(UNCONNECTED, CONNECTED, UNCONNECTED, UNCONNECTED))
        );
    }
    ...
    private static Stream<Arguments> provideUniqueBridges() {
        return Stream.of(
                Arguments.of(List.of(CONNECTED, UNCONNECTED, CONNECTED), List.of(CONNECTED, UNCONNECTED, CONNECTED)),
                Arguments.of(List.of(UNCONNECTED, CONNECTED, UNCONNECTED, CONNECTED), List.of(UNCONNECTED, CONNECTED, UNCONNECTED, CONNECTED))
        );
    }
}
