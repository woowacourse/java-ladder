...
class NonDecidedResultsTest {
    ...
    void testCreateWithSameResultNumbers() {
        ...
        Assertions.assertThatCode(() -> new NonDecidedResults(names, results)).doesNotThrowAnyException();
    }
    ...
    void testCreateWithDifferentResultNumbers() {
        ...
        assertThatThrownBy(() -> new NonDecidedResults(names, results))
