...
public class LineGeneratorTest {
    ...
    void randomLineValidateTest() {
        int personCount = 4;
        final List<Link> generatedLine = lineGenerator.generate(personCount);
    ...
    void unContinuousLineTest() {
        final List<Link> line = List.of(Link.LINKED, Link.UNLINKED, Link.LINKED);
    ...
    void continuousLineTest() {
        final List<Link> line = List.of(Link.LINKED, Link.LINKED, Link.LINKED);
