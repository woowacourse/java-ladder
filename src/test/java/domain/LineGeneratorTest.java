...
public class LineGeneratorTest {
    ...
    void generateLineFailTest(int width_value) {
        assertThatThrownBy(() -> lineGenerator.generateLine(new Width(width_value)))
    ...
    void generateLineSuccessTest(int width_value) {
        assertThatCode(() -> lineGenerator.generateLine(new Width(width_value)))
    ...
    void generateLineTest(int width_value) {
        List<Bridge> line = lineGenerator.generateLine(new Width(width_value));
