...
class PointTest {
    ...
    void previousPointExistThenNotExist() {
        Point currentPoint = Point.choosePoint(Point.EXIST);
    ...
    void previousPointNotExistThenExistOrNotExist() {
        Point currentPoint = Point.choosePoint(Point.NOT_EXIST);
        assertThat(currentPoint).isIn(Point.NOT_EXIST, Point.EXIST);
    }
}
