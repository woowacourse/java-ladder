...
class ExecutionResultsTest {
    ...
    void Should_Success_When_ResultsInput() {
        assertDoesNotThrow(() -> new ExecutionResults(List.of("꽝", "5000", "1000", "3000"), participants));
    }

    @Test
    @DisplayName("결과는 중복될 수 있다.")
    void Should_Success_When_DuplicateResultsInput() {
        assertDoesNotThrow(() -> new ExecutionResults(List.of("꽝", "5000", "꽝", "3000"), participants));
    }
    ...
    void Should_ThrowException_When_NotEqualsSizeOfExecutionResultsAndParticipants() {
        assertThatThrownBy(() -> new ExecutionResults(List.of("꽝", "꽝", "3000"), participants))
