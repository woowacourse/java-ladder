...
public class CalculatorTest {
    ...
    void 문자열_숫자를_정수형으로_변환하기() {
        String input = "//:\\n1:2:3";
        List<Integer> result = Calculator.convertNumber(input);
        assertThat(result).isEqualTo(Arrays.asList(1, 2, 3));
    }
    ...
    void 음수가_포함된_경우() {
        ...
        assertThrows(RuntimeException.class, () -> {
            Calculator.convertNumber(input);
        });
    }
    ...
    void 결과값_출력하기() {
        String input = "//a\\n1a2a3";
        assertThat(Calculator.calSumNumber(Calculator.convertNumber(input))).isEqualTo(6);
    }
