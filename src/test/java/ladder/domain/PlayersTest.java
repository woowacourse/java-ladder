...
public class PlayersTest {
    ...
    @Test
    void goDownTest() {
        List<Player> p = Arrays.asList(new Player(new PlayerName("pobi"), new Position(0)),
                new Player(new PlayerName("crong"), new Position(1)),
        ...
        p = Arrays.asList(new Player(new PlayerName("pobi"), new Position(1)),
