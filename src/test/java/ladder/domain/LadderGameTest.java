...
class LadderGameTest {
    ...
    void 플레이어수_결과수_일치검사() {
        assertThrows(IllegalArgumentException.class, () -> {
            new LadderGame(new PlayerTags("AA,BB,CC"), new ResultTags("A,B", 3), new LadderHeight("5"));
        });
    }
    ...
    void 결과출력할_플레이어_이름_존재_검사() {
        ...
        LadderGame ladderGame = new LadderGame(playerTags, new ResultTags("aaa,bbb,ccc", playerTags.size()), new LadderHeight("5"));
        assertThrows(IllegalArgumentException.class, () -> {
