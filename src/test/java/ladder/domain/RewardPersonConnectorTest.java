...
public class RewardPersonConnectorTest {
    ...
    void setUp() {
        ...
        rewardPersonConnector = new RewardPersonConnector(new Ladder(lines), ladderGameData);
    }

    @Test
    void 생성자확인() {
        assertThat(rewardPersonConnector).isEqualTo(new RewardPersonConnector(new Ladder(lines), ladderGameData));
    }
