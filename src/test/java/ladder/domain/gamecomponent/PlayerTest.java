...
public class PlayerTest {
    ...
    void 플레이어의_position이_0인_경우_오른쪽에_다리가_있는_경우_position_증가() {
        ...
        player.move(new Steps(Arrays.asList(stepExist, stepNotExist, stepNotExist)));
    ...
    void 플레이어의_position이_0인_경우_오른쪽에_다리가_없는_경우_position_일정() {
        ...
        player.move(new Steps(Arrays.asList(stepNotExist, stepExist, stepExist)));
    ...
    void 플레이어의_position이_맨끝인_경우_왼쪽에_다리가_있는_경우_position_감소() {
        ...
        player.move(new Steps(Arrays.asList(stepNotExist, stepNotExist, stepExist)));
    ...
    void 플레이어의_position이_맨끝인_경우_왼쪽에_다리가_없는_경우_position_일정() {
        player = new Player(name, 3);
        player.move(new Steps(Arrays.asList(stepNotExist, stepNotExist, stepNotExist)));
    ...
    void 플레이어의_position이_양끝이_아닌_경우_오른쪽에_다리가_있는_경우_position_증가() {
        ...
        player.move(new Steps(Arrays.asList(stepNotExist, stepExist, stepNotExist)));
        assertThat(player.getPosition()).isEqualTo(2);
    }
