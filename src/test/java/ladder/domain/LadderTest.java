...
public class LadderTest {
    ...
    void Ladder가_제대로_생성되는지_테스트() {
        assertThat(new Ladder(3, new UserSetCrosspointGenerator(userSetCroossbar), 2))
                .isEqualTo(new Ladder(3, new UserSetCrosspointGenerator(userSetCroossbar), 2));
    }

    @Test
    void Ladder의_높이가_1보다_작을_때_예외를_던지는지_테스트() {
        assertThrows(IllegalArgumentException.class, () -> new Ladder(0, new RandomCrosspointGenerator(), 2));
    }
