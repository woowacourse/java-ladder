...
public class LadderRowTest {
    ...
    void 크로스바에_시작_위치를_입력했을_때_결과_위치를_제대로_알려주는지_테스트() {
        LadderRow ladderRow = new UserSetCrosspointGenerator(Arrays.asList(false, false, true, false)).generateLadderRow(3); // 이렇게 생겼음 :   |     |-----|
    ...
    void CrossPoints의_사이즈를_잘_반환해_주는지_테스트() {
        ...
        assertThat(new UserSetCrosspointGenerator(crossbars).generateLadderRow(2).width()).isEqualTo(2);
    }
}
