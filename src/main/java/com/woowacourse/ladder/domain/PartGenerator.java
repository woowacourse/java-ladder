...
public class PartGenerator {
    ...
    public static Ladder generateLadder(int width, int height) {
        ...
        List<Line> lines = generateLines(height, booleans, points, directions);
        return new Ladder(lines,width);
    }

    private static List<Line> generateLines(int height, List<Boolean> booleans, List<Point> points, List<Direction> directions) {
