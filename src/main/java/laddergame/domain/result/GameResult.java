...
public class GameResult {
	...
	private GameResult(BuilderObject players, BuilderObject rewards, Ladder ladder) {
		this.gameResults = new HashMap<>();
		init(players, rewards, ladder);
	}

	private void init(BuilderObject players, BuilderObject rewards, Ladder ladder) {
	...
	public static GameResult of(BuilderObject players, BuilderObject rewards, Ladder ladder) {
