...
public enum ErrorMessage {
    ...
    USER_NAME_NOT_EXISTS_IN_USERS_EXCEPTION("해당 이름은 유저 중에 존재하지 않습니다. 다시 입력해 주세요."),
    RESULT_NAME_LENGTH_EXCEPTION("실행 결과 이름은 8자 이하여야 합니다."),
    RESULT_NAME_BLANK_EXCEPTION("실행 결과 이름은 공백일 수 없습니다."),
    RESULT_NUMBERS_NOT_SAME_WITH_USER_NUMBERS("실행 결과 목록의 수는 유저의 수와 같아야 합니다."),
    NON_VALID_LINE_EXCEPTION("잘못된 사다리가 생성되었습니다.");
