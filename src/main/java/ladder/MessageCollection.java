...
public class MessageCollection {
    ...
    public static final String ERROR_OVER_LENGTH = String.format("ERROR : 이름의 길이는 %d자를 넘을 수 없습니다.", MAX_NAME_LENGTH);
    ...
    public static final String ERROR_LOWER_MIN_HEIGHT = String.format("ERROR : 사다리의 높이는 %d 이상의 수입니다.", MIN_HEIGHT);
