...
public enum ErrorMessage {
    ...
    INVALID_PLAYER_NAME_RANGE(String.format("참가자들의 이름은 1~%d글자여야 합니다.", MAXIMUM_NAME_RANGE)),
    ...
    INVALID_LADDER_HEIGHT_RANGE(String.format("사다리의 높이는 %d보다 커야 합니다.", MINIMUM_HEIGHT)),
    ;
