...
public class ResultView {
    ...
    public void printLadder(List<String> playerNames, int nameLength, List<Line> ladder) {
    ...
    private String convertLadder(List<Line> ladder, int nameLength) {
        return ladder.stream()
                .map(line -> convertLine(line, nameLength))
                .collect(Collectors.joining(System.lineSeparator()));
    }

    private String convertLine(Line line, int nameLength) {
    ...
    private String convertBar(Bar bar, int nameLength) {
