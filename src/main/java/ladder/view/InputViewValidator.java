...
public class InputViewValidator {
    ...
    private static final String RUN_RESULTS_SPLIT_DELIMITER = ",";
    ...
    private static final String RUN_RESULTS_IS_WRONG_SPLIT_DELIMITER_EXCEPTION_MESSAGE = "[ERROR] 실행 결과는 ','로 구분되어야합니다.";
    ...
    private static boolean isRunResultsSplitDelimiterWrong(String runResults) {
        return !runResults.contains(RUN_RESULTS_SPLIT_DELIMITER);
    }
}
