...
public enum ErrorMessage {
    ...
    EXCEPTION_PLAYER_NAME_RESTRICTED_ALL("플레이어 이름은 all 일 수 없습니다."),
    EXCEPTION_PLAYER_NAME_RESTRICTED_QUIT("플레이어 이름은 quit 일 수 없습니다."),
    EXCEPTION_HEIGHT_INVALID_TYPE("정수가 아닙니다."),
    EXCEPTION_HEIGHT_RANGE("사다리 높이는 2 이상 100 이하여야 합니다."),
    EXCEPTION_REWARD_COUNT("실행 결과의 수는 플레이어의 수와 일치해야 합니다."),
    EXCEPTION_REWARD_LENGTH("실행 결과는 1자 이상 5자 이하여야 합니다."),
    EXCEPTION_RESULT_NOT_FOUND("찾을 수 없는 플레이어입니다.");
