...
public class InputView {
    ...
    private static final String TARGET_USER_NAME_MESSAGE = "결과를 보고 싶은 사람은?";
    ...
    public static List<String> readResultNames() {
        System.out.println(RESULT_NAMES_GUIDE_MESSAGE);
        String names = scanner.nextLine();
        System.out.println();
        inputValidator.validateAscii(names);
        return Arrays.stream(names.split(DELIMITER))
    ...
    public static String readTargetUserName() {
        System.out.println(TARGET_USER_NAME_MESSAGE);
