...
public class InputView {
	...
	private final static String RESULTS_SIZE_NOT_MATCH_ERROR_MSG = "실행 결과 수가 참가자 수와 맞지 않습니다.";
	...
	public static String[] readResults(int size) {
		System.out.println(RESULTS_REQUEST_MSG);
		String[] strings = parseListFromInput();
	...
	private static void validateSize(String[] input, int size) {
