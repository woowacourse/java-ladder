...
- [x] 결과를 보고 싶은 사람을 입력받는다.
  - [x] 참여할 사람 중 한 사람을 입력받는다.
  - [x] all을 입력받는다.
- [x] 결과를 보고 싶은 사람 입력은 계속해서 받을 수 있다.
  - [x] all을 입력받을 시 재입력은 종료된다.

## 출력
- [x] 사다리의 최종 결과를 출력한다.
  - [x] 사다리를 출력할 때 사람 이름도 같이 출력한다.
  - [x] 사다리를 출력할 때 실행 결과도 같이 출력한다.
- [x] 결과를 보고 싶은 사람에 맞게 실행 결과를 출력한다.
  - [x] 입력받은 사람에 대한 결과를 출력한다.
  - [x] 입력이 all일 경우 전체 플레이어에 대한 실행 결과를 출력한다.
  - [x] 전체 플레이어의 실행결과는 `이름 : 실행결과` 형식으로 출력한다.
