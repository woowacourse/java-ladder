...
7. 사다리 실행 결과를 출력해야 한다.
    - 사다리 실행 결과는 사용자 이름 개수와 동일하다.
    - 사다리 실행 결과는 최소 2개 최대 10개를 받을 수 있다.
    - 사다리 실행 결과는 공백이 포함될 수 없다.

8. 개인별 이름을 입력하면 개인별 결과를 출력하고, "all"을 입력하면 전체 참여자의 실행 결과를 출력한다.

9. 사다리 실행 결과를 입력받아야 한다.
    - 사다리 실행 결과는 콤마로 구분한다.
    - 사다리 실행 결과에 앞 또는 뒤에 콤마가 있을 경우 예외를 발생시킨다.
...
- [x] 사다리 실행 결과 생성 기능
    ...
    - [x] 실행 결과 길이 검증 기능
- [x] 사다리 실행 결과들 저장 기능
    - [x] 사다리 실행 결과 개수 검증 기능
    - [x] 사다리 실행 결과들 반환 기능
- [x] 사다리 실행 결과들 생성 기능
    - [x] 사다리 실행 결과 입력값 검증 기능
    - [x] 사다리 실행 결과 콤마 구분 기능
