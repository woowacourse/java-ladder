...
| 한글명    | 영문명          | 설명                   |
|--------|--------------|----------------------|
| 참가자    | Participant  | 사다리 게임에 참가하는 사람들을 지칭 |
| 사다리 결과 | LadderPrize  | 사다리 결과를 지칭           |
| 사다리 크기 | LadderHeight | 사다리의 높이를 지칭          |
| 라인의 너비 | LineWeight   | 라이늬 너비를 지칭           |
| 사다리    | Ladder       | 사다리를 지칭              |
| 라인     | Line         | 사다리의 한줄을 지칭          |
| 칸      | Block        | 라인의 한칸을 지칭           |
